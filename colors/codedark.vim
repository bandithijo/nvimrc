...
let s:cdStatus       = {'gui': '#005AA3', 'cterm': s:cterm0E, 'cterm256': '176'}
...
call <sid>hi('Folded',       s:cdPopupFront, s:cdNone, 'none', {})
...
call <sid>hi('StatusLine',   s:cdNone,  s:cdStatus, 'none', {})
call <sid>hi('StatusLineNC', s:cdFront, s:cdStatus, 'none', {})
...
call <sid>hi('htmlTag',            s:cdCursorLight, {}, 'none', {})
" call <sid>hi('htmlEndTag', s:cdGray, {}, 'none', {})
call <sid>hi('htmlEndTag',         s:cdCursorLight, {}, 'none', {})
