...
let s:p.normal.left     = [ [s:base07, s:purple, 'bold'], [s:base07, s:purple] ]
let s:p.normal.right    = [ [s:base07, s:purple, 'bold'], [s:base07, s:purple, 'bold'], [s:base07, s:purple] ]
let s:p.normal.middle   = [ [s:base07, s:purple] ]
let s:p.normal.error    = [ [s:base01, s:base08] ]
let s:p.normal.warning  = [ [s:base01, s:base0A] ]
let s:p.inactive.left   = [ [s:base05, s:purple] ]
let s:p.inactive.right  = [ [s:base05, s:purple] ]
let s:p.inactive.middle = [ [s:base05, s:purple] ]
