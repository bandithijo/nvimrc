...
let g:colors_name="codedark_bandit"
...
call <sid>hi('CursorLineNr',   s:cdPopupFront, s:cdCursorDarkDark, 'none', {})
...
call <sid>hi('StatusLine',     s:cdNone, s:cdLeftGrey, 'none', {})
call <sid>hi('StatusLineNC',   s:cdFront, s:cdLeftGrey, 'none', {})
