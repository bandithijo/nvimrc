...
let s:p.normal.left     = [ [ s:base03, s:base00, 'bold' ], [ s:base03, s:base00 ] ]
let s:p.normal.middle   = [ [ s:base02, s:base00 ] ]
let s:p.normal.right    = [ [ s:base03, s:base00, 'bold' ], [ s:base03, s:base00 ] ]
let s:p.inactive.right  = [ [ s:base02, s:base00 ], [ s:base02, s:base00 ] ]
let s:p.inactive.left   = [ [ s:base02, s:base00 ], [ s:base02, s:base00 ] ]
let s:p.insert.left     = [ [ s:base03, s:yellow, 'bold' ], [ s:base03, s:yellow ] ]
let s:p.insert.middle   = [ [ s:base03, s:yellow ], [ s:base03, s:yellow ] ]
let s:p.insert.right    = [ [ s:base03, s:yellow, 'bold' ], [ s:base03, s:yellow ] ]
...
let s:p.visual.left     = [ [ s:base03, s:green, 'bold' ], [ s:base03, s:green ] ]
let s:p.visual.middle   = [ [ s:base03, s:green ] ]
let s:p.visual.right    = [ [ s:base03, s:green ], [ s:base03, s:green ] ]
let s:p.inactive.middle = [ [ s:base02, s:base00 ] ]
let s:p.tabline.left    = [ [ s:base03, s:base00 ] ]
let s:p.tabline.tabsel  = [ [ s:base03, s:base00, 'bold' ] ]
...
let g:lightline#colorscheme#solarized_bandit#palette = lightline#colorscheme#flatten(s:p)
