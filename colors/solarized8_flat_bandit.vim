...
let g:colors_name = 'solarized8_flat_bandit'
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor guifg=#fdf6e3 guibg=#93a1a1 gui=NONE cterm=NONE
    endif
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      ...
      hi StatusLine   guifg=#93a1a2 guibg=#073642 gui=reverse cterm=reverse
